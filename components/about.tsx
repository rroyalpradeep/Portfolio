          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <a href="https://rroyalpradeep.github.io/Resume/" target="_blank" rel="noopener noreferrer">
                <Button className="bg-primary hover:bg-primary/80 text-white">Download CV</Button>
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-black/40 border-primary/20 hover:border-primary transition-colors">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-400">B.Tech in Computer Science and Engineering (AI & ML)</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black/40 border-primary/20 hover:border-primary transition-colors">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold mb-2 text-white">Interests</h3>
                <p className="text-gray-400">Travel, Gaming, Music, Reading</p>
              </CardContent>
            </Card>

            <Card className="bg-black/40 border-primary/20 hover:border-primary transition-colors md:col-span-2">
