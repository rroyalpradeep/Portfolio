...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <li>
      <Link href={href} className="text-primary-foreground/75 hover:text-primary-foreground transition-colors duration-300">
        {children}
      </Link>
    </li>
  )
  ...
  return (
    <li>
      <a
        ...
        className="text-primary-foreground/75 hover:text-primary-foreground transition-colors duration-300 text-2xl"
      >
        <i className={`fa-brands fa-${icon} transition duration-300 hover:drop-shadow-[0_0_5px] hover:drop-shadow-primary-foreground`}></i>
      </a>
    </li>
  )
}
