...
import { Code, Globe, Database, Terminal, Braces, Server } from "lucide-react"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 content-start">
            ...
            <SkillCard
              ...
              title="Databases"
              skills={["MySQL","MongoDB", "Database Design", "SQL Queries", "Data Modeling"]}
            />

            <SkillCard
              icon={<Braces className="text-primary" size={32} />}
              title="Tools & Frameworks"
              skills={["Git & GitHub", "VS Code", "Bootstrap", "Figma", "MS Office"]}
            />
