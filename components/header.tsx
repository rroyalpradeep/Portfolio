...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-background/80 dark:bg-black/80 backdrop-blur-md shadow-lg" : "bg-transparent"}`}
    >
      ...
      {/* Mobile Navigation */}
      <div
        className={`fixed inset-0 z-40 bg-background/95 dark:bg-black/95 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? "translate-x-0" : "translate-x-full"} md:hidden`}
      >
        {/* Close Button */}
        <button
